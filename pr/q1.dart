...
double addition(double x, String operator, double y) => x + y;

double subtraction(double x, String operator, double y) => x - y;

double multiplication(double x, String operator, double y) => x * y;
